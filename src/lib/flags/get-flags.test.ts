...
describe("getFeatureFlags", () => {
  ...
  it("defaults kb_articles/reports_export to enabled and announcements/surveys/elearning/forum/offline_pwa to disabled when the table is empty or unreachable", async () => {
    const expected = {
      kb_articles: true,
      reports_export: true,
      announcements: false,
