...
// feature that was already shipping. announcements/surveys are brand-new
// features with no such prior behavior to preserve, so they fail closed
// instead: a flags-read failure should never expose an unreviewed feature.
