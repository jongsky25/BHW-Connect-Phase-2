...
import { setArticleStatus, type ArticleActionState } from "./actions";
...
export function ArticleStatusToggle({ id, status }: { id: string; status: "draft" | "published" }) {
  const t = useTranslations("kb");
  const [state, formAction] = useActionState(setArticleStatus, initialState);
