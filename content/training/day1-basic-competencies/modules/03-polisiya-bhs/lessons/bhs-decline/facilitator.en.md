...
By the end of this short lesson the BHW can decline a company's offer out loud, respectfully and with a basis. They acknowledge the visitor's intention, explain the policy clearly, do not promise anything in exchange, and refer the next step to the supervisor. They can also say why accepting "because it's free" hands the decision about patients to the company.

## [time-materials] Time and materials

- **Time:** about 60 minutes in a face-to-face session: the module's 60-minute "Role-playing: explaining each policy to the community" block, from the timing table in the subchapter guide. The module script places this role-play right after "How to decline respectfully". Self-study of the lesson alone takes about 5 minutes (two short sections and one self-check).
- **Materials:** manila paper and markers; the lesson's slides ("How to decline respectfully" and "Wrong versus right: the company's offer"); the four lines of the first slide written large on manila paper; offer cards (a milk company and a medicine company, each with samples and a small gift); an observer checklist for each group of three with the four lines from the slide.
...
Ask the group: *"Have you ever needed to say no to someone who was being kind to you? What made it hard?"* Take two or three answers. Then say: *"Today we practise saying no in a way that keeps both the respect and the policy."*
...
Groups of three: a **visitor**, a **BHW** and an **observer**. Give the visitor an offer card (milk or medicine company). The visitor makes the offer warmly and insists once (*"It's just a small thing, no one will mind"*). The BHW declines out loud, in their own words, then tells the observer in one sentence what they will report to the supervisor. The observer ticks the four lines on the checklist: acknowledged the offer, explained the policy, did not promise an exchange, referred the next step to the supervisor. Rotate roles so every BHW plays the BHW once, with a different card each time. Walk around and listen. This is where you observe.
...
Use the lesson's observation indicator during the role-play: the BHW explains the main point and an appropriate first action in the situation, including what must be checked with the supervisor.
...
- Let them watch a BHW rated **Kaya na** do the same card first, then try it with the observer's checklist in their hand.
- Narrow the task: the visitor does not insist the first time. Add the insisting line once the BHW can do the four lines smoothly.
- Re-observe at the next session with the same offer card, not a new one. The Wrong/Right closing role-play is a quick second chance.
