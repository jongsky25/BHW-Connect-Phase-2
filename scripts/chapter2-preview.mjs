...
// way as its own data: URI; nothing else about the asset shape changes.
...
function figureHtml(a,lang){const alt=esc(a['alt_'+lang]),caption=esc(a['caption_'+lang]);if(!a.video)return '<figure><img src="'+a.inline+'" alt="'+alt+'"><figcaption>'+caption+'</figcaption></figure>';return '<figure><video controls muted playsinline poster="'+a.inline+'" aria-label="'+alt+'" style="max-width:100%"><source src="'+a.video.inline+'" type="video/mp4"></video><figcaption>'+caption+'</figcaption><details><summary>'+(lang==='fil'?'Mga hakbang bilang teksto':'Steps as text')+'</summary><p>'+alt+'</p></details></figure>'}
